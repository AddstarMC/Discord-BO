...
public class GuildConfig {
    ...
    public GuildConfig(String id) {
        ...
        // Expiry time of Invites in seconds ie 120minutes
        expiryTime = 7200;
        redisHost = null;
        redisPort = null;
        redisPassword = null;
    ...
    public void setInviteChannelId(String inviteChannelId) {
    ...
    public void loadConfig() {
        ...
        inviteChannelId = prop.getProperty("inviteChannelId", "");
        ...
        bungeeId = prop.getProperty("bungeeId", null);
        try {
    ...
    private boolean checkSavedConfig(File config) {
        ...
        return (prop.getProperty("welcomeMessage").equals(welcomeMessage) &&
                ...
                prop.getProperty("inviteChannelId").equals(inviteChannelId) &&
    ...
    private Properties createProperties() {
        ...
        prop.setProperty("inviteChannelId",inviteChannelId);
        ...
        prop.setProperty("bungeeId", bungeeId);
        return prop;
    }
